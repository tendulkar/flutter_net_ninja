        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              SizedBox(height: 5),
              Text(value, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey[700])),
            ],
          ),
...
//                   flex: 2,
                    child: GridView.count(
                      ...
                      children: [
                        SummaryCard(title: "Total Sales", value: "\$45,000", icon: Icons.monetization_on),
                        SummaryCard(title: "Users", value: "1,250", icon: Icons.people),
                        SummaryCard(title: "Orders", value: "350", icon: Icons.shopping_cart),
                        SummaryCard(title: "Revenue", value: "\$120,000", icon: Icons.attach_money),
                      ]
                    ),
                  ),
                  SizedBox(height: 20),
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Container(
          ...
          color: Colors.green,
          child: Center(
            child: Text("Available Widths: ${constraints.minWidth.toStringAsFixed(0)} -  ${constraints.maxWidth.toStringAsFixed(0)}, Avaiable Height: ${constraints.minHeight.toStringAsFixed(0)} - ${constraints.maxHeight.toStringAsFixed(0)}")
          )
        );
      }
    );
